...
<table>
    ...
    <c:forEach var="apply" items="${applies}">
        <tr>
            ...
            <td>${apply.state}</td>
            <td>
                <span>  <a href="${pageContext.request.contextPath}/managerMethod/handleApply?id=${apply.id}&wid=${apply.wid}&request=${apply.request}&time=${apply.applyTime}&state=同意">同意</a> </span>
                <span>  <a href="${pageContext.request.contextPath}/managerMethod/handleApply?id=${apply.id}&wid=${apply.wid}&request=${apply.request}&time=${apply.applyTime}&state=拒绝">拒绝</a> </span>
            </td>
        </tr>
    </c:forEach>
</table>
