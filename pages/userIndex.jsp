...
<div class="usercenter container containerban" style="margin-top: 30px;">
    <div class="userrightcon">
        ...
        <div class="grid-container">
            <div><a href="<c:url value="/userMethod/findAllPatient"/>" class="button"><img
                    src="${pageContext.request.contextPath}/pages/images/ic1.png">
                <p>我的就诊人</p></a></div>
            <div><a href="<c:url value="/orderMethod/findAllOrder"/>" class="button"><img
                    src="${pageContext.request.contextPath}/pages/images/ic_home_insurance.png">
                <p>查询订单信息</p></a></div>
            <div><a href="<c:url value="/userMethod/queryHosCertification"/>" class="button"><img
                    src="${pageContext.request.contextPath}/pages/images/ic_home_clinic.png">
                <p>查询住院证明</p></a></div>
            <div><a href="<c:url value="/userMethod/queryHospitalStay"/>" class="button"><img
                    src="${pageContext.request.contextPath}/pages/images/ic_home_hospitalization.png">
                <p>查询住院信息</p></a></div>
            <div><a href="<c:url value="/userMethod/queryOperationInfo"/>" class="button"><img
                    src="${pageContext.request.contextPath}/pages/images/ic_home_map.png">
                <p>查询手术信息</p></a></div>


            <div><a href="<c:url value="/userMethod/logout"/>" class="button"><img
                    src="${pageContext.request.contextPath}/pages/images/ic_home_insurance.png">
                <p>**选择退出**</p></a></div>
            <div><a href="${pageContext.request.contextPath}/pages/Index.jsp" class="button"><img
                    src="${pageContext.request.contextPath}/pages/images/ic_home_insurance.png">
                <p>**选择返回**</p></a></div>
        </div>
