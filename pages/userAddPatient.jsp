...
<head>
    ...
    <title>userAddPatient.jsp</title>
    ...
    <div class="container-fluid navbg">
        <div class="nav">
            <ul class="jiaogaoliang xlk">
                ...
                <li>
              <span>
                <a href="userAddPatient.jsp" class="cur">添加患者信息</a>
              </span>
                </li>
...
<div class="usercenter container containerban" style="margin-top: 30px;">
    <div class="userrightcon">
        ...
        <form class="form-horizontal" action="<c:url value="/userMethod/addPatient"/>" method="post">

            <div class="form-group uegroup">
                <label  for="id" class="col-xs-5 control-label">身份证号：</label>
                <div class="col-xs-3">
            ...
            <div class="form-group uegroup">
                <label for="pname" class="col-xs-5 control-label">就诊人姓名：</label>
                <div class="col-xs-3">
