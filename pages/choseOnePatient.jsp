    ...
    <div class="container-fluid navbg">
        <div class="nav">
            <ul class="jiaogaoliang xlk">
                ...
                <li class="last">
              <span>
                <a href="${pageContext.request.contextPath}/pages/updatePatient.jsp" class="cur">选择就诊人</a>
              </span>
                </li>
            ...
            <div class="form-group" style="margin-bottom: 50px;margin-top: 30px;">
                <div class="col-xs-offset-5 col-xs-2 ">
                    <ul class="btn btn-primary">
                        ...
                        <li>
                            <%= patient.getPname() %>
                            <a href="${pageContext.request.contextPath}/pages/orderInfo1.jsp?pid=<%= patient.getId() %>&pname=<%= patient.getPname() %>" style="color: white">选择</a>
                        </li>
                        <% } %>
                    </ul>
                </div>
