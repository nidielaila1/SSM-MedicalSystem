...
<head>
    ...
    <title>docAddLeaveHosApply.jsp</title>
        ...
        <div class="nav">
            <ul class="jiaogaoliang xlk">
              ...
              <span>
                ...
                <li>
              <span>
                <a href="docAddLeaveHosApply.jsp" class="cur">添加出院时间</a>
              </span>
                </li>
...
<div class="usercenter container containerban" style="margin-top: 30px;">
    <div class="userrightcon">
        ...
        <form class="form-horizontal"  action="<c:url value="/docMethod/addLeaveHosApply"/>" method="post">
            ...
            <div class="form-group uegroup">
                <label  for="dischargeTime" class="col-xs-5 control-label">出院时间：</label>
                <div class="col-xs-3">
                    <input type="date" class="form-control"  id="dischargeTime" name="dischargeTime" required >
                </div>
            </div>
