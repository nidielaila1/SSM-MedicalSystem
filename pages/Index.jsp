        ...
        <c:choose>
            <c:when test="${not empty sessionScope.user}">
                <div class="grid-container">
                    <div><a href="${pageContext.request.contextPath}/deptMethod/findAllDept" class="button"><img
                    ...
                    <div><a href="${pageContext.request.contextPath}/deptMethod/findAllDept" class="button"><img
                        ...
                        <p>科室导航</p></a></div>
                    <div><a href="${pageContext.request.contextPath}/pages/userIndex.jsp" class="button"><img
