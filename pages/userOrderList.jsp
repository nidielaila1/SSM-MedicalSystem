...
<table>
    ...
    <c:forEach var="order" items="${orders}">
        <tr>
            ...
            <td>${order.state}</td>
            <td>
                <span><a href="${pageContext.request.contextPath}/orderMethod/queryOrderById?id=${order.id}">查看详细信息</a></span>
                <span> <a href="${pageContext.request.contextPath}/orderMethod/cancelOrder?id=${order.id}">取消</a>  </span>
            </td>
        </tr>
    </c:forEach>
    </tbody>
