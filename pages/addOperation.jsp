        ...
        <div class="nav">
            <ul class="jiaogaoliang xlk">
              ...
              <span>
                ...
                <li class="last">
              <span>
                <a href="addOperation.jsp" class="cur">添加手术时间</a>
              </span>
                </li>
            </ul>
        </div>
...
<div class="usercenter container containerban" style="margin-top: 30px;">
    <div class="userrightcon">
        ...
        <form class="form-horizontal"  method="post" action="<c:url value="/managerMethod/insertOperationInfo"/>">
            ...
            <div class="form-group uegroup">
                ...
                <div class="col-xs-3">
                    <input class="form-control" type="text" id="operationTime" name="operationTime" value="${operationTime}" required >
                </div>
            </div>
