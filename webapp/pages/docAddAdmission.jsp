...
<head>
    ...
    <title>docAddAdmission.jsp</title>
    ...
    <div class="container-fluid navbg">
        <div class="nav">
            <ul class="jiaogaoliang xlk">
                <li>
              <span>
                <a href="docAddAdmission.jsp" class="cur">添加住院申请理由</a>
              </span>
                </li>
...
<div class="usercenter container containerban" style="margin-top: 30px;">
    <div class="userrightcon">
        ...
        <form class="form-horizontal"  method="post" action="<c:url value="/docMethod/hospitalizationApply"/>" >
            <% String pid = request.getParameter("pid"); %>
            <div class="form-group uegroup">
                <label  for="pid" class="col-xs-5 control-label">患者身份证号：</label>
                <div class="col-xs-3">
                    <input type="text" class="form-control"  id="pid" name="pid" value="<%= pid %>" required >
                </div>
            </div>

            <% String pname = request.getParameter("pname"); %>
            <div class="form-group uegroup">
                <label for="pname" class="col-xs-5 control-label">患者姓名：</label>
                <div class="col-xs-3">
            ...
            <div class="form-group uegroup">
                <label for="dept_name" class="col-xs-5 control-label">科室名称：</label>
                <div class="col-xs-3">
                    <input type="text" class="form-control" id="dept_name" name="dept_name" value="<%= dept_name %>" required>
                </div>
            </div>
