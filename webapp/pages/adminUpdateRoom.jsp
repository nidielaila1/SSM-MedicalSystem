    ...
    <div class="container-fluid navbg">
        <div class="nav">
            <ul class="jiaogaoliang xlk">
                <li class="last">
              <span>
                <a href="updatePatient.jsp" class="cur">更新病房信息</a>
              </span>
                </li>
...
<div class="usercenter container containerban" style="margin-top: 30px;">
    <div class="userrightcon">
        ...
        <form class="form-horizontal" action="<c:url value="/managerMethod/updateRoom"/>" method="post">

            <input type="hidden" name="room" value="${room1.room}"/>

            <div class="form-group uegroup">
                <label for="bed" class="col-xs-5 control-label">床号：</label>
                <div class="col-xs-3">
                    <input type="text" class="form-control" id="bed" name="bed" value="${room1.bed}" required>
                </div>
            </div>
            ...
            <div class="form-group uegroup">
                ...
                <div class="col-xs-3">
                    <input type="text" class="form-control" id="about" name="about" value="${room1.about}" required>
                </div>
            </div>
