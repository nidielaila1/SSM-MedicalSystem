...
<head>
    ...
    <link rel="${pageContext.request.contextPath}/pages/shortcut icon" href="images/logo2.png">
        ...
        <div id="navbar" class="topright navbar-collapse collapse">
            <div class="signapp">
                ...
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/pages/home.html"
                   role="button">首页</a>
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/pages/docIndex.jsp"
                   role="button">我的</a>
        ...
        <c:choose>
            <c:when test="${not empty sessionScope.doctor}">
                <div class="grid-container">
                    <div><a href="<c:url value="/docMethod/findOwnWorkDay"/>" class="button"><img
                            src="${pageContext.request.contextPath}/pages/images/ic_home_insurance.png">
                        <p>查我的工作日</p></a></div>
                    <div><a href="<c:url value="/docMethod/findAllApplies"/>" class="button"><img
                            src="${pageContext.request.contextPath}/pages/images/ic_home_insurance.png">
                        <p>查我的换班申请</p></a></div>
                    <div><a href="<c:url value="/docMethod/findOrdersByDocId"/>" class="button"><img
                            src="${pageContext.request.contextPath}/pages/images/ic_home_insurance.png">
                        <p>查我的挂号信息</p></a></div>
                    <div><a href="<c:url value="/docMethod/queryHosStayInfo"/>" class="button"><img
                            src="${pageContext.request.contextPath}/pages/images/ic_home_clinic.png">
                        <p>查询住院信息</p></a></div>
                    <div><a href="<c:url value="/docMethod/queryAdmissionsByDocId"/>" class="button"><img
                            src="${pageContext.request.contextPath}/pages/images/ic_home_hospitalization.png">
                        <p>我的住院证明</p></a></div>
                    <div><a href="<c:url value="/docMethod/queryHosApplyByDocId"/>" class="button"><img
                            src="${pageContext.request.contextPath}/pages/images/ic_home_map.png">
                        <p>我的出院申请</p></a></div>
                    <div><a href="<c:url value="/docMethod/queryOperationRequests"/>" class="button"><img
                            src="${pageContext.request.contextPath}/pages/images/ic_home_tel.png">
                        <p>我的手术申请</p></a></div>


                    <div><a href="<c:url value="/docMethod/logout"/>" class="button"><img
                            src="${pageContext.request.contextPath}/pages/images/ic_home_insurance.png">
                        <p>**选择退出**</p></a></div>
                </div>
...
<c:if test="${empty sessionScope.doctor}">
    <script>
        alert("请先登录");
        window.location.href = "${pageContext.request.contextPath}/pages/docLogin.jsp";
    </script>
</c:if>
