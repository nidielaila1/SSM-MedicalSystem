...
<head>
    ...
    <title>AddHospitalStayInfo</title>
    ...
    <div class="container-fluid navbg">
        <div class="nav">
            <ul class="jiaogaoliang xlk">
                ...
                <li>
              <span>
                <a href="addHospitalStayInfo.jsp" class="cur">添加住院信息</a>
              </span>
                </li>
...
<div class="usercenter container containerban" style="margin-top: 30px;">
    <div class="userrightcon">
        ...
        <form class="form-horizontal" method="post" action="<c:url value="/managerMethod/addHospitalStayInfo"/>">
            <input type="hidden" name="adm_id" value="<%= request.getParameter("admId") %> ">

            <div class="form-group uegroup">
                <label for="room" class="col-xs-5 control-label">病房号：</label>
                <div class="col-xs-3">
                    <input type="text" class="form-control" id="room" name="room" value="<%= request.getParameter("room") %>" readonly>
                </div>
            </div>
            <div class="form-group uegroup">
                <label for="bed" class="col-xs-5 control-label">床位号：</label>
                <div class="col-xs-3">
                    <input type="text" class="form-control" id="bed" name="bed" value="<%= request.getParameter("bed") %>"readonly>
                </div>
            </div>
